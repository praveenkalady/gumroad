  ...
  return (
    <>
      <section>
        ...
        <Calendar
          locale="en-US"
          className="rounded border border-border p-4 [&_.react-calendar__navigation]:flex [&_.react-calendar__navigation__label]:flex-grow [&_.react-calendar__navigation__label]:text-center [&_.react-calendar__navigation__label]:font-bold [&_.react-calendar__navigation__label:disabled]:opacity-100 [&_.react-calendar__navigation__arrow]:text-sm [&_.react-calendar__navigation__arrow]:leading-[1.4] [&_.react-calendar__viewContainer]:text-center [&_.react-calendar__month-view__weekdays]:pt-2 [&_.react-calendar__month-view__weekdays]:pb-2 [&_.react-calendar__month-view__weekdays]:font-bold [&_.react-calendar__month-view__weekdays_abbr]:text-sm [&_.react-calendar__month-view__weekdays_abbr]:leading-[1.4] [&_.react-calendar__month-view__weekdays_abbr]:no-underline [&_.react-calendar__month-view__days]:overflow-hidden [&_.react-calendar__month-view__days]:rounded-lg [&_.react-calendar__month-view__days]:border [&_.react-calendar__month-view__days]:border-border [&_.react-calendar__month-view__days__day]:relative [&_.react-calendar__month-view__days__day]:py-2 [&_.react-calendar__month-view__days__day:disabled]:opacity-100 [&_.react-calendar__month-view__days__day:disabled_abbr]:opacity-30 [&_.react-calendar__month-view__days__day::before]:absolute [&_.react-calendar__month-view__days__day::before]:content-[''] [&_.react-calendar__month-view__days__day::after]:absolute [&_.react-calendar__month-view__days__day::after]:content-[''] [&_.react-calendar__month-view__days__day:nth-child(n+8)::before]:left-0 [&_.react-calendar__month-view__days__day:nth-child(n+8)::before]:top-0 [&_.react-calendar__month-view__days__day:nth-child(n+8)::before]:w-full [&_.react-calendar__month-view__days__day:nth-child(n+8)::before]:border-t [&_.react-calendar__month-view__days__day:nth-child(n+8)::before]:border-border [&_.react-calendar__month-view__days__day:not(:nth-child(7n))::after]:right-0 [&_.react-calendar__month-view__days__day:not(:nth-child(7n))::after]:top-0 [&_.react-calendar__month-view__days__day:not(:nth-child(7n))::after]:h-full [&_.react-calendar__month-view__days__day:not(:nth-child(7n))::after]:border-r [&_.react-calendar__month-view__days__day:not(:nth-child(7n))::after]:border-border [&_.react-calendar__month-view__days__day--neighboringMonth_abbr]:invisible [&_.react-calendar__month-view__days__day--neighboringMonth.react-calendar__tile--active]:bg-inherit [&_.react-calendar__tile--active]:bg-accent [&_.react-calendar__tile--active]:text-[rgb(var(--contrast-accent))]"
          minDetail="month"
          maxDetail="month"
          view="month"
